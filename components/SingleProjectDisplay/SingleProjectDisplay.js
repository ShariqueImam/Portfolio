...
const style = {
  wrapper: "px-3 py-8 border-[1px] border-stone-700 flex flex-col w-[95%] md:w-[30%] my-8",
  img: "content-image h-[27vh] w-[25vw]",
  heading: "text-stone-400 font-bold my-4 md:my-6 px-6",
  description: "text-stone-300 mb-4 md:mb-6 px-6",
